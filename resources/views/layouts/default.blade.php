                            ...
                            <li>
                                <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                    <li>
										...
										<span class="photo">
										<img src="http://homestead.app/assets/layout3/img/avatar2.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Lisa Wong </span>
                                    ...
                                    <li>
                                        <a href="inbox.html?a=view">
										<span class="photo">
										<img src="http://homestead.app/assets/layout3/img/avatar3.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Richard Doe </span>
                                    ...
                                    <li>
                                        <a href="inbox.html?a=view">
										<span class="photo">
										<img src="http://homestead.app/assets/layout3/img/avatar1.jpg" class="img-circle" alt="">
										</span>
										<span class="subject">
										<span class="from">
										Bob Nilson </span>
...
<script src="http://homestead.app/assets/scripts/demo.js" type="text/javascript"></script>
<script src="http://homestead.app/assets/pages/scripts/tasks.js" type="text/javascript"></script>
